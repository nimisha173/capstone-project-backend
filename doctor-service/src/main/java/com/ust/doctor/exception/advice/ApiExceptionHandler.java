package com.ust.doctor.exception.advice;

import com.ust.doctor.exception.DoctorAlreadyExistException;
import com.ust.doctor.exception.DoctorNotFoundException;
import com.ust.doctor.exception.dto.ApiError;
import com.ust.doctor.exception.dto.ApiValidationError;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleDoctorNotFoundException(DoctorNotFoundException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
    @ExceptionHandler(DoctorAlreadyExistException.class)
    protected ResponseEntity<Object> handleDoctorAlreadyExistException(DoctorAlreadyExistException ex) {
